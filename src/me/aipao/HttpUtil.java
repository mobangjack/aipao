...
public class HttpUtil {
	 ...
	 * Send request
	 */
	public static String request(String url, String method, Map<String, String> queryParas, String data, Map<String, String> headers) {
	...
	public static String get(String url, Map<String, String> queryParas, Map<String, String> headers) {
		return request(url, GET, queryParas, null, headers);
	}
	...
	public static String put(String url, Map<String, String> queryParas, String data, Map<String, String> headers) {
		return request(url, PUT, queryParas, data, headers);
	}
	...
	public static String put(String url, String data, Map<String, String> headers) {
		return request(url, PUT, null, data, headers);
	}
	...
	public static String delete(String url, Map<String, String> queryParas, Map<String, String> headers) {
		return request(url, DELETE, queryParas, null, headers);
	}
	...
	public static String delete(String url, Map<String, String> headers) {
		return request(url, DELETE, null, null, headers);
	}
	...
	public static String post(String url, Map<String, String> queryParas, String data, Map<String, String> headers) {
		return request(url, POST, queryParas, data, headers);
	}
